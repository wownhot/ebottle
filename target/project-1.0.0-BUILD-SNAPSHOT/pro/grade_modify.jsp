...
function cancel(){
	location.href="/gradelist?currentPage=1";
}
function check() {
...
<div class="container">
		<div class="jumbotron">
		<% GradeVO go = (GradeVO)request.getAttribute("GRADEVO"); %>
	
	

	<form class="form-signin" action="/grademodify" method="post"
				name="f2">
				<input type="hidden" name="seq" value="<%=go.getGrade_seq()%>">
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="panel panel-default">
								<div class="panel-body">
									<h3 class="text-center">등급수정</h3>
									<form class="form form-signup" role="form">
									 <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span>
                            </span>
                            <input type="text" name="account" class="form-control" placeholder="이름을 입력하세요" value="<%=go.getUsers_account()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="Text" placeholder="이메일 양식에 맞게 작성해주세요  :) 예 : xxx@naver.com" name="rpoint" class="form-control" value="<%=go.getRequestpoint()%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-star"></span></span>
                            <input type="Text" placeholder="아이디를 입력해주세요  " name="drate" class="form-control" value="<%=go.getDiscountrate()%>"/>
                        </div>
                    </div>
                <input type="submit" class="btn btn-sm btn-primary btn-block" value="완료"></input>
