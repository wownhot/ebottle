...
<nav class="navbar navbar-inverse">
	...
	<div class="container">
		<div class="jumbotron">
			...
			<p class="text-center"><a class="btn btn-primary btn-lg" href="/productlist?currentPage=1" role="button">포인트 쇼핑하기</a></p>
		</div>
		<div class="row">
			<div class="col-sm-4">
				<h4>EBProject의 특징</h4>
				<p>EBPoint는 누구나 쉽게 공병을 포인트로 교환하여 사용할 수 있습니다.</p>
