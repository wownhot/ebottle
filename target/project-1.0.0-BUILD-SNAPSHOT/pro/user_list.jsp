...
<nav class="navbar navbar-inverse">
	...
	<div class="container">
      ...
      <p ><h3 style="text-align:center">회원목록</h3></p>
      <p><input type="button" class="btn btn-success" onClick="del()" value="회원삭제" style="color:white;background-color:black;border:none">
      <button class="btn btn-warning" onclick="document.getElementById('id01').style.display='block'" style="color:white;background-color:black;border:none;margin-top:0px;width:auto;">회원추가</button>
      </p>
      <hr>
...
%>
 ...
 <form class="form-signin modal-content animate" name="input" action="/userinsert" method="post">
<div class="container">
    <div class="row">
