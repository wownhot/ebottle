			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" name="log" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="userid" id="userid" tabindex="1" class="form-control" placeholder="아이디" value="" onKeyPress="if (event.keyCode==13){check('login');event.returnValue=false}">
									</div>
									<div class="form-group">
										<input type="password" name="password" id="password" tabindex="2" class="form-control" placeholder="비밀번호" onkeypress="if (event.keyCode==13){check('login');event.returnValue=false}">
									</div>
								...
								<form id="register-form" name="input" method="post" role="form" style="display: none;">
									<div class="form-group">
