...
function cancel(){
	location.href="/userlist?currentPage=1";
}
function check() {
	 var form = document.f2; 
		 if(form.pw.value==""||form.name.value==""||form.email.value==""||form.id.value==""||form.account.value==""){
...
<div class="container">
	...
	<form class="form-signin" action="/usermodify" method="post"
				name="f2">
				<input type="hidden" name="seq" value="<%=uvo.getSeq()%>">
				<div class="container">
					<div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="이름을 입력하세요" value="<%=uvo.getName()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="Text" placeholder="이메일 양식에 맞게 작성해주세요  :) 예 : xxx@naver.com" name="email" class="form-control" value="<%=uvo.getEmail()%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-star"></span></span>
                            <input type="Text" placeholder="아이디를 입력해주세요  " name="id" class="form-control" value="<%=uvo.getId()%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                            <input type="Text" placeholder="등급을 입력해주세요  " name="account" class="form-control" value="<%=uvo.getAccount()%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                            <input type="Text" placeholder="비밀번호를 입력해주세요  " name="pw" class="form-control" value="<%=uvo.getPw()%>"/>
                        </div>
                    </div>
                <button type="button" class="btn btn-sm btn-primary btn-block" onclick="check()">완료</button>
                <button type="button" onClick="cancel()" class="btn btn-sm btn-danger btn-block">취소</button>
									</form>
								</div>
	</div>
	</div>
