...
<body>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<ul class="dropdown-menu">
					<li><a href="/productlist?currentPage=1">세븐일레븐</a></li>
					<li><a href="#">GS25</a></li>
					<li><a href="#">CU</a></li>		
				</ul>
				</li>
							...
							<div class="details col-md-6">
								<div class="panel panel-default text-center">
									<h3>
										<div class="panel-title">
											<span class="glyphicon glyphicon-list-alt"></span> 상품이름
										</div>
									</h3>
								...
								<div class="panel panel-default text-center">
									<div class="rating">
										<h3>
											<div class="panel-title">
												<span class="glyphicon glyphicon-info-sign"></span> 재고량
											</div>
										</h3>
										<hr>
										<h4><%=po.getStock()%></h4>
								...
								<div class="panel panel-default text-center">
									<h3>
										<div class="panel-title">
											<span class="glyphicon glyphicon-comment"></span> 소개
										</div>
									</h3>
									<hr>

									<h4 style="text-align: left; margin-left: 10%"><%=des%></h4>
								</div>
								<div class="panel panel-default text-center">
									<h3>
										<div class="panel-title">
											<span class="glyphicon glyphicon-credit-card"></span> 가격
										</div>
									</h3>
									<input type="hidden" name="price" value="<%=price%>">
									<hr>
									<h2>
										<font color="purple"><%=price%>Point 
									</h2>
									</font>
								</div>
								</h3>
								...
								<div class="text-center">
									<button class="add-to-cart btn btn-default" type="button"
										...
										<span class="glyphicon glyphicon-gift"></span>상품 구매
									</button>
								</div>
								<div class="text-center">
									<button class="add-to-cart btn btn-default" type="button"
								...
								<div class="text-center">
									...
									<a type="button" class="add-to-cart btn btn-default"
										href="javascript:test();" style="width:100%"> <img
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<h4>그룹소개</h4>
				<p>저희는 EBProject를 개발한 김기택, 정재현, 오원택, 정우근, 신준태, 이세현
					입니다.
			</div>
			<div class="col-sm-2">
