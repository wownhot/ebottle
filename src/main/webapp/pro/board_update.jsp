...
<nav class="navbar navbar-inverse">
 ...
 %></li>
	...
	<%
		...
		bo = (BoardVO)session.getAttribute("BOARD_UPDATE");
		int bseq = bo.getBseq();
 ...
 <form class="form-signin" action="/boardupdatecomplete?bseq=<%=bseq %>" method="post" enctype="multipart/form-data">
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label><b></b></label><br>
     					<textarea rows="5" cols="" style="width:100%"name="contents"  required><%=contents %></textarea>
                    </div>
                    <div class="form-group">
                        
                      	파일업로드 <input class="file" id="input-1" type="file"  name="file" >
                        
                    </div>
                    

                </div>
                <input type="submit" class="btn btn-sm btn-primary btn-block" value="게시글 수정"> 
              
               </form>
				</form>
				  <form class="form-signin" action="/boarddelete?bseq=<%=bseq %>" method="post" >
               <input type="submit" class="btn btn-sm btn-primary btn-block" value="게시글 삭제">
               </form>
            </div>
        </div>
    </div>
