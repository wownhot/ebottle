...
%>
 ...
 %></li>
	...
	<div class="container">
		<div class="jumbotron">
		<div style="padding-right:20px;padding-top:30px;padding-left:20px;background-color:white">
		<p><h3 style="text-align:center">회원님이 적립한 포인트는 <span style="color:red;font-size: larger;"><%=request.getAttribute("POINT")%></span> Point입니다.</h3></p>
      <p ><h3 style="text-align:center">현재 회원님의 회원등급은 <span style="font-size:larger;"><%=vo.getAccount() %></span> 입니다.</h3></p>
      </p>
      <hr>
      ...
      <table class = "table table-striped table-hover">
        <thead>
          <tr>
          	...
          	<th>		</th>
            <th style="font-size:larger;">등급</th>
            <th style="font-size:larger;">기준포인트</th>
            <th style="font-size:larger;">할인율</th>
            <th style="font-size:larger;">필요포인트</th>
          </tr>
        </thead>
        <tbody>
        <%
...
<tr>
	...
	<td><%=list.get(i).getRequestpoint()%>P</td>
	<td><%=list.get(i).getDiscountrate()%>%</td>
	<td style="color:red;"><%if(list.get(i).getRequestpoint()-hehe>0){%><%=list.get(i).getRequestpoint()-hehe%>P<%}%></td>
