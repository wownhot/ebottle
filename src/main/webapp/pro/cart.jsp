...
%>
 ...
 %></li>
	...
	<div class="container">
		...
		<p style="background-repeat:no-repeat;background-size:120px 120px;height:120px;text-align: center;padding-top:50px;font-size: 30px">장바구니</p>
...
<%} %>
 	...
 	<div class="text-center">
		...
		<button onClick="productBuy();" style="width:45%;display:inline-block;margin-left:3%;margin-right:3%">구매하기</button>
		<button onClick="cartDelete();" style="width:45%;dispaly:inline-block;background-color:#3BAFFF">삭제하기</button>
