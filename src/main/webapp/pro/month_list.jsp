...
<nav class="navbar navbar-inverse">
 ...
 %></li>
	...
	<div class="container">
		<div class="jumbotron" style="padding-right:200px;padding-left:200px;">
...
ArrayList<PointVO> list2;
        try{
			list = (ArrayList<PointVO>)request.getAttribute("MONTH_LIST");
			list2 = (ArrayList<PointVO>)request.getAttribute("MONTH_LIST2");
        }catch(Exception e){
        	list = new ArrayList<PointVO>();
        	list2 = new ArrayList<PointVO>();
        }
...
<tr>
	<td></td>
	<td><a href="/pointlist?mon=<%=list.get(i).getPseq()%>&currentPage=1"><%=list.get(i).getPseq()%>월</a></td>
	<td><a href="/pointlist?mon=<%=list.get(i).getPseq()%>&currentPage=1"><%=list.get(i).getPval()%>Point</a></td>
	<td><a href="/pointlist?mon=<%=list.get(i).getPseq()%>&currentPage=1"><%=list2.get(i).getPval()%>Point</a></td>
</tr>
<%
}
%>
