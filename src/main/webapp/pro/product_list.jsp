...
<nav class="navbar navbar-inverse">
 ...
 %></li>
	...
	<div class="container">
		 ...
		 <div class="row">
				...
				<div class="col-md-3 col-sm-6">
					<span class="thumbnail"> <img
						...
						<h4 style="height:30px"><%=pList.get(i).getPname()%></h4>
						<hr class="line">
						<div class="row">
		...
		<input type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" value="상품 추가">
            </div>
        </div>
    </div>
...
<form class="form-signin" name="input" action="/productadd" method="post" enctype="multipart/form-data">
<div class="container">
    <div>
        <div style="width:700px; padding-left: 350px; padding-top:110px">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
									<div class="input-group">
										<span class="input-group-addon"><span
											class="glyphicon glyphicon-usd"></span></span> <input type="Text"
											class="form-control" placeholder="상품가격을 입력하세요" name="price"
											required />
									</div>
                    </div>
                    <div class="form-group">
									<div class="input-group">
										<span class="input-group-addon"><span
											...
											type="Text" class="form-control" placeholder="상품재고를 입력하세요"
											name="stock" required />
									</div>
                    </div>
								<div class="form-group">
									<label><b>상품설명</b></label><br>
									<textarea rows="5" cols="" style="width: 100%" name="desc"
										placeholder="상품설명을 입력하세요" required></textarea>
								</div>
								<div class="form-group">

									<input class="file" id="input-1" type="file"
										placeholder="상품이미지를 등록하세요" name="img" required>
