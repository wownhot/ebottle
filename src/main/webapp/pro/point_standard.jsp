...
<nav class="navbar navbar-inverse">
 ...
 %></li>
   ...
   <div class="container">
      <div class="jumbotron">
      <div style="width:90%;height:100%;background-color:white;padding:20px 10px;margin-left:5%">
      <p><h3 style="text-align:center;">적립기준 및 방법</h3></p>
      <p><div style="width:100%;height:auto;"><img src="../img/EB.png" style="width:100%"></div></p>
      </div>
