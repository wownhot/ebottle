...
try{
 ...
 %></li>
	...
	<div class="container">
      ...
      <p style=";background-repeat:no-repeat;background-size:120px 120px;height:120px;text-align: center;padding-top:50px;font-size: 30px">등급관리</p>
      <p><input type="button" class="btn btn-success" onClick="del()" value="등급삭제" style="color:white;background-color:black;border:none">
      <button class="btn btn-warning" data-toggle="modal" data-target="#myModal" style="color:white;background-color:black;border:none;margin-top:0px;width:auto;">등급추가</button>
      </p>
      <hr>
