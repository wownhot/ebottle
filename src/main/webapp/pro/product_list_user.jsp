		...
		<div class="jumbotron" style="background-color: white;">	
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
					<span class="thumbnail"><a href="/productdetail?pseq=<%=pList.get(i).getPseq()%>"><img
						src="<%=pList.get(i).getUrl()%>"
						alt="..." style="height:140px;"></a> 
						<h4 style="height:30px"><%=pList.get(i).getPname()%></h4>
						<hr class="line">
						<div class="row">
					
								<p class="price" style="margin-left:10%;"><span style="color:#FF24A3;">EBMall가</span>&nbsp;&nbsp;<%=pList.get(i).getPrice()%> P</p>
