...
<body style="width:1000px">
	...
	%>
	<div style="height:auto;width:70%;margin-left: 60%;margin-right: 10%;margin-top:0%;
	...
	<div style="padding-bottom:5%;background:white;border-radius: 5px;">
		<p style="margin-bottom:0"><img class="form" alt="상품" src="<%=vo.getProduct_img()%>" style="width:40%; margin-left:30%"></p>
